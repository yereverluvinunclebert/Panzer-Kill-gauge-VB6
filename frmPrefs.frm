...
Begin VB.Form panzerPrefs 
   AutoRedraw      =   -1  'True
   Caption         =   "Panzer Kill Button Preferences"
   ClientHeight    =   10650
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8970
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":1294
            Left            =   1530
            List            =   "frmPrefs.frx":1296
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbScrollWheelDirection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":1298
            Left            =   1995
            List            =   "frmPrefs.frx":129A
            Style           =   2  'Dropdown List
            TabIndex        =   87
   ...
   Begin VB.Frame fraPosition 
      ...
      Begin VB.Frame fraPositionInner 
         ...
         Begin VB.ComboBox cmbWidgetLandscape 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5F7C
            Left            =   2250
            List            =   "frmPrefs.frx":5F7E
            Style           =   2  'Dropdown List
            TabIndex        =   72
         ...
         Begin VB.ComboBox cmbWidgetPortrait 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5F80
            Left            =   2250
            List            =   "frmPrefs.frx":5F82
            Style           =   2  'Dropdown List
            TabIndex        =   69
            ToolTipText     =   "Choose the alarm sound."
            Top             =   5505
         ...
         Begin VB.ComboBox cmbWidgetPosition 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5F84
            Left            =   2265
            List            =   "frmPrefs.frx":5F86
            Style           =   2  'Dropdown List
            TabIndex        =   66
            ToolTipText     =   "Choose the alarm sound."
            Top             =   2100
         ...
         Begin VB.ComboBox cmbAspectHidden 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5F88
            Left            =   2265
            List            =   "frmPrefs.frx":5F8A
            Style           =   2  'Dropdown List
            TabIndex        =   63
            ToolTipText     =   "Choose the alarm sound."
            Top             =   0
         ...
         End
         Begin VB.Label lblPosition 
            Caption         =   $"frmPrefs.frx":61FD
            Height          =   3045
            Index           =   6
            Left            =   2265
            TabIndex        =   65
            Tag             =   "lblAlarmSoundDesc"
            ToolTipText     =   $"frmPrefs.frx":63A2
            Top             =   450
            Width           =   5175
         End
         Begin VB.Label lblPosition 
...
Private Sub chkGaugeFunctions_Click()
    btnSave.Enabled = True ' enable the save button
    'BodyWidget.Rotating = chkGaugeFunctions.Value
End Sub
...
Private Sub chkPreventDragging_Click()
    ...
    Else
        ...
        If aspectRatio = "landscape" Then
            txtLandscapeHoffset.Text = fMain.BodyForm.Left
            txtLandscapeVoffset.Text = fMain.BodyForm.Top
        Else
            txtPortraitHoffset.Text = fMain.BodyForm.Left
            txtPortraitYoffset.Text = fMain.BodyForm.Top
        End If
    End If
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    If chkWidgetHidden.Value = 0 Then
        BodyWidget.Hidden = False

        frmTimer.revealWidgetTimer.Enabled = False
        PzEWidgetHidden = "0"
    Else
        BodyWidget.Hidden = True

        frmTimer.revealWidgetTimer.Enabled = True
        PzEWidgetHidden = "1"
    End If
    
    sPutINISetting "Software\PzKill", "widgetHidden", PzEWidgetHidden, PzESettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer Kill gauge VB6\Panzer Kill Gauge.vbp"
...
Private Sub cmbScrollWheelDirection_Click()
   On Error GoTo cmbScrollWheelDirection_Click_Error
    ...
    btnSave.Enabled = True ' enable the save button
    BodyWidget.ZoomDirection = cmbScrollWheelDirection.List(cmbScrollWheelDirection.ListIndex)
...
Private Sub btnHelp_Click()
    ...
    On Error GoTo btnHelp_Click_Error
        ...
        Else
            MsgBox ("%Err-I-ErrorNumber 11 - The help file - PzKill Help.html - is missing from the help folder.")
        End If
...
'    PzEhLocationPercPrefValue
    ...
    If PzEStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzKillWidget", """" & App.Path & "\" & "Panzer Kill Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzKillWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PzESettingsFile) Then
        sPutINISetting "Software\PzKill", "enableTooltips", PzEEnableTooltips, PzESettingsFile
        sPutINISetting "Software\PzKill", "enableBalloonTooltips", PzEEnableBalloonTooltips, PzESettingsFile
        sPutINISetting "Software\PzKill", "showTaskbar", PzEShowTaskbar, PzESettingsFile
        
        sPutINISetting "Software\PzKill", "gaugeSize", PzEGaugeSize, PzESettingsFile
        sPutINISetting "Software\PzKill", "scrollWheelDirection", PzEScrollWheelDirection, PzESettingsFile
                
        sPutINISetting "Software\PzKill", "gaugeFunctions", PzEGaugeFunctions, PzESettingsFile
        'sPutINISetting "Software\PzKill", "animationInterval", PzEAnimationInterval, PzESettingsFile
        'sPutINISetting "Software\PzKill", "widgetSkew", 'PzEWidgetSkew, PzESettingsFile
        
        sPutINISetting "Software\PzKill", "aspectHidden", PzEAspectHidden, PzESettingsFile
        sPutINISetting "Software\PzKill", "widgetPosition", PzEWidgetPosition, PzESettingsFile
        sPutINISetting "Software\PzKill", "widgetLandscape", PzEWidgetLandscape, PzESettingsFile
        sPutINISetting "Software\PzKill", "widgetPortrait", PzEWidgetPortrait, PzESettingsFile

        sPutINISetting "Software\PzKill", "prefsFont", PzEPrefsFont, PzESettingsFile
        sPutINISetting "Software\PzKill", "prefsFontSize", PzEPrefsFontSize, PzESettingsFile
        sPutINISetting "Software\PzKill", "prefsFontItalics", PzEPrefsFontItalics, PzESettingsFile
        sPutINISetting "Software\PzKill", "prefsFontColour", PzEPrefsFontColour, PzESettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzKill", "windowLevel", PzEWindowLevel, PzESettingsFile
        sPutINISetting "Software\PzKill", "preventDragging", PzEPreventDragging, PzESettingsFile
        
        sPutINISetting "Software\PzKill", "opacity", PzEOpacity, PzESettingsFile
        sPutINISetting "Software\PzKill", "widgetHidden", PzEWidgetHidden, PzESettingsFile
        sPutINISetting "Software\PzKill", "hidingTime", PzEHidingTime, PzESettingsFile
        sPutINISetting "Software\PzKill", "ignoreMouse", PzEIgnoreMouse, PzESettingsFile
        
        sPutINISetting "Software\PzKill", "startup", PzEStartup, PzESettingsFile

        sPutINISetting "Software\PzKill", "enableSounds", PzEEnableSounds, PzESettingsFile
        sPutINISetting "Software\PzKill", "lastSelectedTab", PzELastSelectedTab, PzESettingsFile
        
        sPutINISetting "Software\PzKill", "debug", PzEDebug, PzESettingsFile
        sPutINISetting "Software\PzKill", "dblClickCommand", PzEDblClickCommand, PzESettingsFile
        sPutINISetting "Software\PzKill", "openFile", PzEOpenFile, PzESettingsFile
        sPutINISetting "Software\PzKill", "defaultEditor", PzEDefaultEditor, PzESettingsFile
...
'        msgCnt = 0
    ...
    ' sets the characteristics of the Body and menus immediately after saving
...
Private Sub adjustPrefsControls()
    ...
    If PzEPrefsFont <> vbNullString Then
        Call changeFormFont(panzerPrefs, PzEPrefsFont, Val(PzEPrefsFontSize), fntWeight, fntStyle, PzEPrefsFontItalics, PzEPrefsFontColour)
    End If
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If PzEEnableTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz Kill operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If PzEEnableTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz Kill operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
...
'    'BodyWidget.RotationSpeed = sliAnimationInterval.Value
'    btnSave.Enabled = True ' enable the save button
'
'End Sub
...
'    btnSave.Enabled = True ' enable the save button
'    BodyWidget.BodySkewDeg = 'sliWidgetSkew.Value
'End Sub
...
Public Sub setPrefsTooltips()
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    If PzEEnableTooltips = "1" Then
        ...
        cmbScrollWheelDirection.ToolTipText = "To change the direction of the mouse scroll wheel when resiziing the Body gauge."
        ...
        chkShowTaskbar.ToolTipText = "Check the box to show the widget in the taskbar. Desktop widgets typically do NOT display in the taskbar/"
        chkEnableTooltips.ToolTipText = "Check the box to enable tooltips for all controls on the main program"
        sliGaugeSize.ToolTipText = "Adjust to a percentage of the original size. Any adjustment in size takes place instantly (you can also use Ctrl+Mousewheel hovering over the Body itself)."
        'sliWidgetSkew.ToolTipText = "Adjust to a degree skew of the original position. Any adjustment in direction takes place instantly (you can also use the Mousewheel hovering over the Body itself."
...
Private Sub setThemeShade(ByVal redC As Integer, ByVal greenC As Integer, ByVal blueC As Integer)
    ...
    sPutINISetting "Software\PzKill", "skinTheme", PzESkinTheme, PzESettingsFile ' now saved to the toolsettingsfile
...
Private Sub setModernThemeColours()
    ...
    'Pz KillPrefs.mnuAuto.Caption = "Auto Theme Selection Cannot be Enabled"
