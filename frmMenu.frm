...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer Kill Button Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Panzer Kill Gauge One-Page Help"
      End
      ...
      Begin VB.Menu mnuSwitchOff 
         Caption         =   "Switch off my functions (Killing Processes)"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening a folder for this widget - " & folderPath & " It doesn't seem to have a valid working directory set.", "Panzer Kill Gauge Confirmation Message", vbOKOnly + vbExclamation
...
Private Sub mnuHelpHTM_Click()
    On Error GoTo mnuHelpHTM_Click_Error
        ...
        Else
            MsgBox ("The help file - pzKill.html.html- is missing from the help folder.")
        End If
